	...
	return {
		c() {
			(m = l('p')),
				...
				(y = l('p')),
				(j = l('strong')),
				(A = u('Web Scraping Framework:')),
				(x = n()),
				(k = l('p')),
				(z = u('Selenium WebDriver')),
				(C = n()),
				(L = l('p')),
				(w = l('strong')),
				(B = u('Data Structuring and Manipulation Libraries:')),
				(D = n()),
				(S = l('p')),
				(K = u('pandas, numpy')),
				(W = n()),
		...
		l(e) {
			...
			T = o(i, 'STRONG', {});
			var se = p(T);
			(N = d(se, 'Technologies:')), se.forEach(t), i.forEach(t), (G = c(e)), (a = o(e, 'P', {}));
			var f = p(a);
			(g = o(f, 'IMG', { src: !0, alt: !0 })),
				(O = c(f)),
				(h = o(f, 'IMG', { src: !0, alt: !0 })),
				(H = c(f)),
				(v = o(f, 'IMG', { src: !0, alt: !0 })),
				(V = c(f)),
				(_ = o(f, 'IMG', { src: !0, alt: !0 })),
				f.forEach(t),
				(R = c(e)),
				(y = o(e, 'P', {}));
			var re = p(y);
			j = o(re, 'STRONG', {});
			var le = p(j);
			(A = d(le, 'Web Scraping Framework:')),
				le.forEach(t),
				re.forEach(t),
				(x = c(e)),
				(k = o(e, 'P', {}));
			var oe = p(k);
			(z = d(oe, 'Selenium WebDriver')), oe.forEach(t), (C = c(e)), (L = o(e, 'P', {}));
			var ae = p(L);
			w = o(ae, 'STRONG', {});
			var ne = p(w);
			(B = d(ne, 'Data Structuring and Manipulation Libraries:')),
				ne.forEach(t),
				ae.forEach(t),
				(D = c(e)),
				(S = o(e, 'P', {}));
...
class ye extends de {
	constructor(m) {
		super(), be(this, m, null, he, ge, {});
	}
}
export { ye as default, _e as metadata };
