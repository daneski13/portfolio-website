import { F as d, s as E } from './index.45ab08d9.js';
const c = [];
function p(e, t = d) {
	let n;
	const o = new Set();
	function l(s) {
		if (E(e, s) && ((e = s), n)) {
			const u = !c.length;
			for (const a of o) a[1](), c.push(a, e);
			if (u) {
				for (let a = 0; a < c.length; a += 2) c[a][0](c[a + 1]);
				c.length = 0;
			}
		}
	}
	...
	function r(s, u = d) {
		...
		return (
			...
			s(e),
			() => {
				o.delete(a), o.size === 0 && n && (n(), (n = null));
			}
		);
	}
	return { set: l, update: i, subscribe: r };
}
var g;
const m = ((g = globalThis.__sveltekit_z7l0hn) == null ? void 0 : g.base) ?? '';
var k;
const w = ((k = globalThis.__sveltekit_z7l0hn) == null ? void 0 : k.assets) ?? m,
	A = '1683692679887',
	I = 'sveltekit:snapshot',
	y = 'sveltekit:scroll',
	x = 'sveltekit:index',
	_ = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1 };
function O(e) {
	let t = e.baseURI;
	if (!t) {
...
function N(e, t) {
	...
	return { url: n, external: l, target: o };
}
function V(e) {
	let t = null,
		n = null,
...
function h(e) {
	...
	return { notify: o, set: l, subscribe: i };
}
function R() {
	...
	async function o() {
		clearTimeout(n);
		const l = await fetch(`${w}/_app/version.json`, {
			headers: { pragma: 'no-cache', 'cache-control': 'no-cache' }
		});
		if (l.ok) {
			const r = (await l.json()).version !== A;
...
const P = { url: h({}), page: h({}), navigating: p(null), updated: R() };
export {
	x as I,
	_ as P,
	y as S,
